# ============================================================
# VELLA V3 APP — SINGLE FILE EDITION (CORE 100% ALIGNED)
# SHORT ONLY / ONE-WAY MODE
# ERROR 0% / DESIGN FREEZE
# ============================================================

import time, os, json, hmac, hashlib, requests, tempfile
...
class FIXED:
    ...
    BTC_STALE_MS = 120_000
    SUI_STALE_MS = 120_000

    STATE_FILE = "vella_state.json"
...
class CFG:
    ...
    investUSDT: float = 50
    tp1Pct: float = 0.85
    tp1SplitPct: float = 0.5
    trailingSensitivity: int = 7
    volatilityMinPct: float = 0.8
    volumeSpikeRatio: float = 1.5
    ema9EntryTolerance: float = 0.08

    # LIVE
    slPct: float = 1.2
    tp1Enabled: bool = True
    tpTrailingEnabled: bool = True
    volatilityFilterEnabled: bool = True
    volumeFilterEnabled: bool = True
    regimeFilterEnabled: bool = True
    entryFilterEnabled: bool = True
...
def cycle():
    ...
    if cfg.volatilityFilterEnabled and range_pct < cfg.volatilityMinPct:
        return
